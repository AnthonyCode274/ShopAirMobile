    ...
    return (
        <View style={{width: '100%', height: '100%', backgroundColor: 'white'}}>
            ...
            <View style={Styles.body}>
                ...
                <View style={{marginTop:10,marginLeft:55,width: '70%', height: 50, backgroundColor: 'white', justifyContent: 'space-around', alignItems: 'center',}}>
                <Text style={{ textAlign: 'center',  fontSize: 15 ,}}>Đơn hàng của bạn sẽ sớm được giao. Cảm ơn bạn đã mua sản phẩm!</Text>
                </View>
                <View style={{marginTop:10,marginLeft:100, width: '50%', height: 40, backgroundColor: 'black', justifyContent: 'space-around', alignItems: 'center', borderRadius:50}}>
