    ...
    return (
        <View>
            ...
            {/* -------------------------------------------------------------------- */}
                ...
                {/* -------------------------------------------------------------------- */}
            <View style={{width:'100%', height:200, alignItems: 'center', backgroundColor:'blue', fontSize:16,}}>
                <View style={{width:'95%', height:'10%', flexDirection:'row',justifyContent:'space-between'}}>
                    <Text>NightMore.heartshop.com</Text>
