        ...
        <View>
            ...
            {/* -------------------------------------------------------------------- */}
                ...
                {/* -------------------------------------------------------------------- */}
                    ...
                    renderItem = {({item}) => {
                        return (
                            <View style={{width:'100%', height:200, alignItems: 'center', backgroundColor:'blue', }}>
                            ...
                            <View style={{width:'95%', height:'80%',backgroundColor:'pink', flexDirection:'row',}}>
                    ...
                    />
                     <View style={{width:'100%', height:100, backgroundColor:'#EAF6FF',}}>
                    <View style={{flexDirection:'row', alignItems: 'center',width:'100%',height:'30%',backgroundColor:'green'}}>
                    <Image style={{width:20, height:20, marginLeft:10,}} source={back}/>
                    <Text style={{fontSize:20}}>PHƯƠNG THỨC THANH TOÁN</Text>
                    </View>
                    <View style={{height:'70%', justifyContent:'center'}}>
                        <Text style={{fontSize:20, marginLeft:30,}}>Thanh toán bằng tiền mặt</Text>
                    </View>
                    </View>
                    </View>
