    ...
    return (
        <View>
            ...
            <View style={Styles.body}>
                <View style={{ width: '20%', height: 50, backgroundColor: 'red', justifyContent: 'space-around', alignItems: 'center',flexWrap:'center'}}>
                    <Text>Thành Công</Text>
                </View>
                <View style={{ width: '80%', height: 100, backgroundColor: 'blue', justifyContent: 'center', alignItems: 'center',}}>
                    <Image source={back}/>
                </View>
            </View>
